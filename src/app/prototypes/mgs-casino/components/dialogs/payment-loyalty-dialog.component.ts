...
import { MgsPosDialogComponent } from '../pos-dialog.component';
import { MockGuest, MockPoint, PaymentType } from '../../types';

@Component({
  selector: 'mgs-payment-loyalty-dialog',
  standalone: true,
  imports: [CommonModule, IconsModule, MgsPosDialogComponent],
  template: `
    <mgs-pos-dialog [open]="open" maxWidth="md" (dialogClose)="dialogClose.emit()">
...
export class MgsPaymentLoyaltyDialogComponent implements OnChanges {
  @Input() open = false;
