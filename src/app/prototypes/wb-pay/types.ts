export interface WbPayCredentials {
  id: string;
  storeId: string;
  storeName: string;
  terminalId: string;
...
export const ERROR_MESSAGES: ErrorMessage[] = [
  ...
  { code: 'HTTP_403', text: 'Ошибка авторизации WB Pay. Обратитесь к администратору' },
  { code: 'TIMEOUT', text: 'Время ожидания оплаты истекло' },
];
