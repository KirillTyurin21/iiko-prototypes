...
const SCENARIO_CELLS: CatalogCell[] = [
  ...
  // === Маркетинг и статусы — NEW: v1.4 (H9) ===
  {
    id: 'scenario-marketing-with-select',
    label: 'Маркетинг → Выбор робота → Старт',
    description: 'П1 → выбор свободного робота → индикатор круиза + toast «отправлено»',
    icon: 'radio',
    iconColor: '#3b82f6',
    category: 'scenario',
  ...
  // === Fire-and-forget lifecycle — NEW: v1.4 (H14) ===
  {
    ...
    description: 'Подтверждение → спиннер → dispatched toast → 5 сек → completed toast',
    icon: 'zap',
    iconColor: '#8b5cf6',
    category: 'scenario',
  ...
  {
    id: 'scenario-task-completed-polling',
    label: 'Polling: задача завершена',
    description: 'Демо: зелёный completed toast (имитация polling)',
    icon: 'check-circle-2',
    iconColor: '#22c55e',
    category: 'scenario',
...
const NOTIFICATION_CELLS: CatalogCell[] = [
  ...
  },
  {
    ...
    label: 'Toast: Уборка отправлена',
    description: 'Акцентный toast «Уборка посуды — отправлено. Стол 3»',
    icon: 'send',
    iconColor: '#b8c959',
    category: 'notification',
    scenario: 'cleanup-ok',
  ...
  },
  {
    ...
    label: 'Toast: Блюда отправлены',
    description: 'Акцентный toast «Доставка блюд — отправлено. Стол 7»',
    icon: 'send',
    iconColor: '#b8c959',
    category: 'notification',
  ...
  },
  {
    ...
    label: 'Toast: Маркетинг запущен',
    description: 'Акцентный toast «Маркетинг-круиз — отправлено» (без subtitle — нет стола)',
    icon: 'send',
    iconColor: '#b8c959',
    category: 'notification',
    scenario: 'marketing-with-select',
